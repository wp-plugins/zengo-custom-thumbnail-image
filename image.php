                ...
                <p>
						<div>
							<form action="<?php echo $_SERVER['PHP_SELF']; ?>?page=zengo-gallery&action=add" method="post">
								<table class="table121">
									<tr>
										<th align="left" class="table121">Title</th>
										<td align="center" class="table121">:</td>
										<td colspan="2" class="table121"><input type="text" name="title" id="title" required="required" class="regular-text">(Special charecters will be Ignored.)</td>
									</tr>
									<tr>
               ...
               <h2>Zengo Gallery Setting</h2>
				...
				<div id="view3">
					...
					<?php
								...
								<form action="<?php echo $_SERVER['PHP_SELF']; ?>?page=zengo-gallery&action=modified" method="post">
									...
									<table  class="table121">
										<tr>
											<th align="left" class="table121">Title</th>
											<td align="center" class="table121">:</td>
											<td colspan="2" class="table121"><input type="text" name="title" id="title" value="<?php echo $name; ?>" required="required" class="regular-text"><input type="hidden" name="did" value="<?php echo $did; ?>"></td>
										</tr>
										<tr>
											<th align="left" class="table121">Select Thumbnail Image</th>
											<td align="center" class="table121">:</td>
							...
							?>
					<section class="">
					  <div class="container zengo-scroll-tab zengo-col-1">
						<table class="">
						  <thead>
							<tr class="header">
								<th class="table1211"><div>No.</div></th>
								<th class="table1211"><div>Title</div></th>
								<th class="table1211"><div>Thumbnail Image</div></th>
								<th class="table1211"><div>Main Image</div></th>
								<th class="table1211"><div>Edit</div></th>
								<th class="table1211"><div>Delete</div></th>
							</tr>
						 </thead>
						 <tbody>
							<?php
